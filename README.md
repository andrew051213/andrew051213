...
<p align="left"> 
  ...
  <div style="width: 100px; background-color: #e0e0e0; border-radius: 5px; margin: 5px 0;">
    <div style="height: 10px; border-radius: 5px; background-color: #4caf50; width: 10%;"></div>
  </div>
  ...
  <div style="width: 100px; background-color: #e0e0e0; border-radius: 5px; margin: 5px 0;">
    <div style="height: 10px; border-radius: 5px; background-color: #4caf50; width: 50%;"></div>
  </div>
